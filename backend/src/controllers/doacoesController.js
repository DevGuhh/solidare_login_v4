...
import {
    criarDoacaoSchema
} from "../validators/doacaoValidator.js";
...
const atualizarDoacaoSchema =
    criarDoacaoSchema.partial();


const alterarComprovanteSchema =
    z.object({

        comprovante:
            z.boolean({
                required_error:
                    "Informe o status do comprovante.",
                invalid_type_error:
                    "O campo comprovante deve ser verdadeiro ou falso."
            })
...
function montarFiltroAcessoDoacao(
    req,
    id
) {
    ...
    /*
     * O ADMIN pode acessar qualquer doação.
     *
     * O usuário INSTITUICAO fica restrito
     * às doações de sua própria instituição.
     */
    if (
        req.user.role !== "ADMIN"
    ) {
    ...
    async (
        ...
        try {
            ...
            // =========================================
                ...
                /*
                 * O ADMIN pode filtrar por instituição:
                 *
                 * GET /doacoes?instituicaoId=5
                 */
                if (
                    req.query
                        .instituicaoId !==
...
const alterarComprovanteDoacao =
    async (
        req,
        res
    ) => {
        ...
        try {
            ...
            return res
                ...
                .json({
                    ...
                    error:
                        "Erro ao atualizar o comprovante da doação."
...
const cancelarDoacao =
    async (
        ...
        try {
            ...
            console.error(
                `DELETE /doacoes/${req.params.id} - erro:`,
                error
            );
